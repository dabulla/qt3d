...
public:
    ...
    virtual void getTrackedObject(QMatrix4x4 &transform) = 0;
    virtual int getTrackedObjectType() = 0;
    virtual void getTrackedObjectVertices(QVector<float> &vertices) = 0;
    virtual void getTrackedObjectTexture(QOpenGLTexture *texture) = 0;
